...
#def Account():
	#try:
		...
		# Gmail is the default, you can change at
		# will of course.
		...
		# try login into server
		#server = smtplib.SMTP(provider, port)
		#server.login(account, password)
		#server.starttls()
		#print('[ SMTP Connection ESTABLISHED ]')

	# authorization error print
	#except Exception as e:
	#	print('''
#
#				[ Authorization ERROR ]
#
#			WhoDis.py file to ensure you gave 
#			the correct credentials.
#
#			Solution 2: Sign into your email account
#			on your web browser to establish a (known)
#			connection if the device has NOT already.
#
#			Solution 3: Make sure "Allow Third Party
#			Apps" is enabled on the google account.
#			settings).
#
#			''')
#		print(str(e))
...
def Text():
	try:
		...
		for x in range(0, amount):
			...
			# increment + 1 for every message sent
			sent +=1
